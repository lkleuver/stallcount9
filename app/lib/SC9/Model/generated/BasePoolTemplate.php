 ...
 */
abstract class BasePoolTemplate extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('pool_template');
        ...
        $this->hasColumn('numberOfRounds', 'integer', 4, array(
             'type' => 'integer',
             'length' => '4',
             ));
