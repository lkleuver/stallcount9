...
class SC9_Controller_Print extends SC9_Controller_Core {
	...
	public function scheduleAction() {
		...
		$pdf->Output($stage->Division->title.'_schedule_round_'.$roundRank.'.pdf','I');
	}
	...
	public function resultsAction() {
		...
		$pdf->Output($stage->Division->title.'_results_round_'.$roundRank.'.pdf','I');
	}
	...
	public function standingsAction() {
		...
		$pdf->Output($stage->Division->title.'_standings_after_round_'.$roundRank.'.pdf','I');
